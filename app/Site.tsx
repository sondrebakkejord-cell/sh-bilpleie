...
export default function Site({ id = "a" }: { id?: string }) {
  const t = THEMES[id] ?? THEMES.a;
  return (
    <div className="min-h-screen bg-[var(--bg)] text-stone-100 pb-16 md:pb-0" style={t.vars} data-variant={id}>
      ...
      <main>
        ...
        {/* Marquee */}
        <section className="relative bg-brand text-white py-6 overflow-hidden border-y-2 border-black/20">
        ...
        {/* Statement */}
        <section className="py-32 md:py-44 px-6 bg-[var(--bg)]">
        ...
        <section className="relative h-[82vh] overflow-hidden bg-[var(--bg)]">
        ...
        <section id="tjenester" className="px-6 bg-[var(--bg)]">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {EXTRA.map((e, i) => (
                <Reveal key={e.title} delay={i * 110}>
                  <article className="h-full bg-[var(--surface)] border border-[var(--border)] hover:border-brand hover:bg-[var(--surface)] transition-colors p-8 md:p-10 flex flex-col">
        ...
        <section className="relative h-[80vh] overflow-hidden bg-[var(--bg)]">
          <Parallax speed={0.1} className="absolute inset-x-0 -top-[8%] h-[116%]">
            <div className="relative w-full h-full">
        ...
        {/* Biler */}
        <section id="biler" className="py-28 px-6 bg-[var(--surface)] border-y border-[var(--border)]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1">
              {GALLERY.map((src, i) => (
                <Reveal key={i} delay={(i % 3) * 90}>
                  <article className="group relative aspect-[4/5] overflow-hidden bg-[var(--surface)]">
        ...
        {/* Kontakt */}
        <section id="kontakt" className="py-28 px-6 bg-[var(--bg)] border-t border-[var(--border)]">
          <div className="max-w-6xl mx-auto">
            ...
            <Reveal delay={80} className="overflow-hidden border border-[var(--border)] mt-14 h-[420px]">
              <iframe
      ...
      <footer className="bg-[var(--bg)] text-stone-500 py-12 px-6 text-center text-xs border-t border-[var(--border)]">
