...
export default function Home() {
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 pb-16 md:pb-0">
      ...
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-40 px-6 py-6 backdrop-blur-md bg-stone-950/30">
      ...
      <main>
        ...
        {/* Marquee */}
        <section className="relative bg-brand text-white py-8 overflow-hidden border-y-2 border-[#173a86]">
          <div className="flex items-center gap-16 whitespace-nowrap marquee-track">
            {[...MARQUEE_BRANDS, ...MARQUEE_BRANDS, ...MARQUEE_BRANDS].map((b, i) => (
              <span key={i} className="inline-flex items-center gap-16 text-2xl md:text-3xl font-bold tracking-[0.15em] uppercase">
        ...
        {/* Statement */}
        <section className="py-40 md:py-56 px-6 bg-stone-950">
        ...
        <section id="tjenester" className="px-6 bg-stone-950">
          <div className="max-w-6xl mx-auto pt-32 md:pt-44">
        ...
        {/* Biler */}
        <section id="biler" className="py-36 px-6 bg-stone-900 border-y border-stone-800">
        ...
        {/* Merker */}
        <section className="py-36 px-6 bg-stone-950">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              <div className="bg-white p-9 flex flex-col items-center justify-center">
              ...
              <div className="bg-stone-300 p-9 flex flex-col items-center justify-center">
        ...
        {/* Kontakt */}
        <section id="kontakt" className="py-36 px-6 bg-stone-950 border-t border-stone-800">
          <div className="max-w-6xl mx-auto">
            ...
            <Reveal>
              ...
              <div className="space-y-8 border-t border-stone-800 pt-10">
      ...
      <footer className="bg-stone-950 text-stone-500 py-16 px-6 text-center text-xs border-t border-stone-800">
